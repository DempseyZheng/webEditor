...
//        return super.onJsAlert(view, url, message, result);
  ...
  public void getText(final ValueCallback<String> callback){
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
      evaluateJavascript("javascript:RE.getText();", callback);
    }else{
        loadUrl("javascript:RE.alertText();");
    }

  }
  public void getHtml(final ValueCallback<String> callback){
//    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
//      evaluateJavascript("javascript:RE.getHtml();", callback);
//    }
    loadUrl("javascript:RE.alertHtml();");
  }
